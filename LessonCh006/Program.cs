...
namespace LessonCh006
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //ministry.AddSupervisorDepartment("Игорь", "Максимов", 45, "Начальник департамента", "Департамент_3/Департамент_3_0/Департамент_3_0_0");

            //ministry.AddEmployee("Алексей", "Пивоваров", 35, 1000, "Программист", "Департамент_0");
            //ministry.AddEmployee("Исламбек", "Казаев", 39, 1000, "Программист", "Департамент_0");
            //ministry.AddEmployee("Павел", "Петренко", 36, 1000, "Программист", "Департамент_3/Департамент_3_0/Департамент_3_0_0");
            //ministry.AddEmployee("Семён", "Самохин", 37, 1000, "Программист", "Департамент_3/Департамент_3_0/Департамент_3_0_0");
            //ministry.AddEmployee("Аримат", "Кузбеков", 38, 1000, "Программист", "Департамент_3/Департамент_3_0/Департамент_3_0_0");

            //ministry.DeleteEmployee(0, "Исламбек", "Казаев", 39, 1000, "Программист", "Департамент_0");
